    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <main className={`transition-all duration-300 ${
        ...
        <div className="max-w-[1800px] mx-auto px-8 pb-8">
          <TopBar
            title="Managing"
            subtitle="Admin and system management"
            showPortalPublished={false}
          />
          
          <div className="flex items-center justify-center h-96">
            <div className="text-center">
              <h2 className="text-2xl font-semibold text-gray-900 mb-2">Managing Dashboard</h2>
              <p className="text-gray-500">Admin options and system management coming soon...</p>
            </div>
          </div>
        </div>
      </main>

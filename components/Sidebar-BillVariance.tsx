              ...
              <div className="px-4">
                ...
                <div className="space-y-1">
                  {policies.items.map((item, idx) => (
                    <div
                      key={idx}
                      className="flex items-center justify-between px-3 py-2 rounded-md text-sm text-black/70 hover:text-black hover:bg-[#E8E4DF]/50 transition-colors cursor-pointer leading-none"
                    >
                      <span className="leading-none">{item.label}</span>
                      {item.hasToggle && (
                        <div className="w-3 h-3 rounded-sm bg-[#D4CFC9] border border-[#B8B3AD]"></div>
                      )}
                    </div>
                  ))}
                </div>
